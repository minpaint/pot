...
3. **Регистр должностей:** Все переменные `*_position` автоматически приводятся к нижнему регистру для соответствия правилам русского языка в протоколах.

4. **Формат инициалов:** Инициалы всегда идут перед фамилией: "И.О. Фамилия" (например, "И.Р. Фаттахов").

5. **Иерархия комиссий:** Система автоматически ищет комиссию для сотрудника по иерархии:
