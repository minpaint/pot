...
3. **Автоматическая очистка документов:** После генерации документа система **автоматически удаляет пустые параграфы** и строки таблиц. Это означает:
   ...
   - Это работает для всех протоколов автоматически — ничего дополнительно настраивать не нужно
